...
function textResult(text: string, isError = false) {
  // Host contract (pi extensions.md): tools signal errors by throwing;
  // returned objects never set the error flag. Translate the upstream
  // isError flag into the throw the runtime understands.
